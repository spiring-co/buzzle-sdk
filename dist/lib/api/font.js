...
function Font(baseUrl, headers) {
    var _this = this;
    return {
        get: function (name) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, apiRequest_1.default(process.env.REACT_APP_API_URL + "/fonts?name=" + name, {
                        method: "GET",
                        headers: headers,
                    })];
            });
        ...
        create: function (data) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, apiRequest_1.default(baseUrl + "/fonts", {
                        method: "POST",
                        headers: headers,
